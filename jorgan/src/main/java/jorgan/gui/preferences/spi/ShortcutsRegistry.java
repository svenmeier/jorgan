...
public class ShortcutsRegistry {
	...
	public static List<Shortcut> createShortcuts() {
		ArrayList<Shortcut> shortcuts = new ArrayList<Shortcut>();

		for (ShortcutsProvider provider : PluginUtils
				.lookup(ShortcutsProvider.class)) {
			shortcuts.addAll(provider.getShortcuts());
		}
