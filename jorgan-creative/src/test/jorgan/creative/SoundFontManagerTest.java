 ...
 */
public class SoundFontManagerTest {
	...
	public static void main(String[] args) {
		...
		try {
			System.setProperty(SoundFontManager.JORGAN_CREATIVE_LIBRARY_PATH, "./build/native/win32");
			...
			for (int i = 0; i < num; i++) {
				// get its name
				System.out
						.println("Device #" + i + ": " + mgr.getDeviceName(i));
