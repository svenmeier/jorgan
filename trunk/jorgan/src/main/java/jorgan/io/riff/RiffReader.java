...
public class RiffReader {
  ...
  public RiffChunk read() throws RiffFormatException {
    ...
    try  {
      ...
      if (RiffChunk.RIFF_ID.equals(id)) {
        ...
        throw new RiffFormatException("riff does not start with RIFF or RIFX");
      }
      ...
      RiffChunk riffChunk = (RiffChunk)createChunk(factory, id, dataLength);
  ...
  public Chunk readChunk() throws RiffFormatException {
    ...
    ChunkFactory factory = (ChunkFactory)factories.get(id);
    if (factory == null) {
   ...
   * Create a chunk.
   *
   * @param factory    factory to create chunk with  
   * @param id         id of chunk to create
   * @param dataLength length of data of chunk to create
   * @return           created chunk
   * @throws RiffFormatException
   */
  private Chunk createChunk(ChunkFactory factory, String id, int dataLength) throws RiffFormatException {
    try {
   ...
   * 
   * @param id      id to register factory for
