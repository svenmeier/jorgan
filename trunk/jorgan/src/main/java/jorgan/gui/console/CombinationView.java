...
public class CombinationView extends View {
  ...
  protected void paintNonStyle(Graphics2D g) {
    ...
    paintCombination(g, PADDING, PADDING, size.width - 2*PADDING, size.height - 2*PADDING);
  ...
  private void paintCombination(Graphics2D g, int x, int y, int width, int height) {  
  ...
  public void pressed(KeyEvent ev) {
    ...
    Shortcut shortcut = combination.getShortcut();
