...
import jorgan.midi.MidiMergerProvider;
...
public class MidiConfigPanel extends ConfigurationPanel {
  ...
  public MidiConfigPanel() {
    ...
    textArea.setText(resources.getString("config.midi.description"));
    ...
    public String getColumnName(int column) {
      switch (column) {
        case 0:
          return " ";
        case 1:
          return resources.getString("config.midi.device");
        case 2:
          return resources.getString("config.midi.channel");
      }
      return null;
    }
