...
/**
 * Test for {@link ResourceBundleStore}.
 */
public class ResourceBundleStoreTest extends TestCase {
	...
	protected void setUp() throws Exception {
		store = new ResourceBundleStore("bias/store/ResourceBundleStoreTest");
	}
	...
	public void testGetValue() throws Exception {
		...
		assertEquals("ResourceBundleStore", value);
	}
}