...
public class CLICategory extends JOrganCategory {
	...
	@Override
	protected void read() {
		String encoding = this.encoding.getValue();
		if (encoding == null) {
			encodingDefaultRadioButton.setSelected(true);
			encodingComboBox.setEnabled(false);
			encodingComboBox.setSelectedItem(CLI.getDefaultEncoding());
		} else {
			encodingOtherRadioButton.setSelected(true);
	...
	protected void write() {
		if (encodingDefaultRadioButton.isSelected()) {
