...
/**
 * A {@link java.beans.BeanInfo} wrapper that removes non-writeable property
 * descriptors.
 */
public class WriteableBeanInfo implements BeanInfo {
	 ...
	 *            bean info to wrap
	 */
	public WriteableBeanInfo(BeanInfo info) {
		this.info = info;
	}
