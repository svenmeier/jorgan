...
install_name_tool -change /Users/sven/workspace/fluidsynth/build/src/libfluidsynth.1.dylib @loader_path/libfluidsynth.dylib libfluidsynth.dylib
install_name_tool -change /usr/local/Cellar/glib/2.28.5/lib/libgthread-2.0.0.dylib @loader_path/libgthread-2.0.0.dylib libfluidsynth.dylib
install_name_tool -change /usr/local/Cellar/glib/2.28.5/lib/libglib-2.0.0.dylib @loader_path/libglib-2.0.0.dylib libfluidsynth.dylib
install_name_tool -change /usr/local/Cellar/gettext/0.18.1.1/lib/libintl.8.dylib @loader_path/libintl.8.dylib libfluidsynth.dylib
install_name_tool -change /usr/local/Cellar/libsndfile/1.0.23/lib/libsndfile.1.dylib @loader_path/libsndfile.1.dylib libfluidsynth.dylib
...
install_name_tool -change /usr/local/Cellar/gettext/0.18.1.1/lib/libintl.8.dylib @loader_path/libintl.8.dylib libglib-2.0.0.dylib
