 ...
 */
package jorgan.memory.gui.file;
...
/**
 * A filter for midi files.
 */
public class MemoryFileFilter extends FileFilter {

	/**
	 * The file suffix of memory files.
	 */
	public static final String FILE_SUFFIX = ".memory";
